...
echo -e "\nStarted service configure-k8s-ctrl-plane-suse . . .\n"
...
var_k8s_cfg_dir='/root/configure-k8s-ctrl-plane-suse'
var_logs_wget="${var_k8s_cfg_dir}/logs-configure-k8s-ctrl-plane-suse.log"
...
then
	...
	systemctl disable configure-k8s-ctrl-plane-suse.service
...
} | tee -a /dev/tty0 /root/configure-k8s-ctrl-plane-suse/logs-configure-k8s-ctrl-plane-suse.log
