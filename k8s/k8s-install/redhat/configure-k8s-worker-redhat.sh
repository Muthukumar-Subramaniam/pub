...
echo -e "\nStarted service configure-k8s-worker-redhat . . .\n"
...
var_k8s_cfg_dir='/root/configure-k8s-worker-redhat'
var_logs_wget="${var_k8s_cfg_dir}/logs-configure-k8s-worker-redhat.log"
...
systemctl disable configure-k8s-worker-redhat.service

} | tee -a /dev/tty0 /root/configure-k8s-worker-redhat/logs-configure-k8s-worker-redhat.log
