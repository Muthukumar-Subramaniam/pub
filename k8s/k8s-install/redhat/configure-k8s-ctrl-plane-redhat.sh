...
echo -e "\nStarted service configure-k8s-ctrl-plane-redhat . . .\n"
...
var_k8s_cfg_dir='/root/configure-k8s-ctrl-plane-redhat'
var_logs_wget="${var_k8s_cfg_dir}/logs-configure-k8s-ctrl-plane-redhat.log"
...
then
	...
	systemctl disable configure-k8s-ctrl-plane-redhat.service
...
} | tee -a /dev/tty0 /root/configure-k8s-ctrl-plane-redhat/logs-configure-k8s-ctrl-plane-redhat.log
