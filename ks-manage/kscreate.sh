...
v_get_ipv4_domain='muthuks.local.lab'
v_get_ipv4_netmask='255.255.255.0'
v_ks_manage_dir='/scripts_by_muthu/muthuks-server/ks-manage'
v_kickstart_dir='/var/www/muthuks-web-server.muthuks.local.lab/ks-manager-kickstarts'
...
v_kickstart_dir="${v_kickstart_dir}/${v_get_hostname}"
