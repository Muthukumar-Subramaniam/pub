...
nmcli connection add connection.id eth0 connection.interface-name eth0 type ethernet ipv4.method manual ipv4.addresses 192.168.168.253/24 ipv4.gateway 192.168.168.1 ipv4.dns 192.168.168.201 ipv4.dns-search muthuks.local.lab ipv6.method disabled
